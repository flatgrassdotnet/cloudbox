...
func ListAll(w http.ResponseWriter, r *http.Request) {
	...
	list, err := db.FetchPackageListAll(r.URL.Query().Get("type"), r.URL.Query().Get("dataname"), r.URL.Query().Get("author"), r.URL.Query().Get("search"), offset, count, sort)
	if err != nil {
